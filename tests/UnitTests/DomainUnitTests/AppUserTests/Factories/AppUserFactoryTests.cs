...
public class AppUserFactoryTests
{
    ...
    public void Create_AppUser_Username(string userName, string email, string firstName, string lastName, DateOnly dob, bool shouldSucceed)
    {
        if (shouldSucceed)
        {
    ...
    public void Create_AppUser_Email(string userName, string email, string firstName, string lastName, DateOnly dob, bool shouldSucceed)
    {
        if (shouldSucceed)
        {
            var exception = Record.Exception(() =>
    ...
    public void Create_AppUser_FirstName(string userName, string email, string firstName, string lastName, DateOnly dob, bool shouldSucceed)
    {
        if (shouldSucceed)
        {
            var exception = Record.Exception(() =>
    ...
    public void Create_AppUser_DOB(string userName, string email, string firstName, string lastName, DateOnly dob, bool shouldSucceed)
    {
        if (shouldSucceed)
        {
            var exception = Record.Exception(() =>
