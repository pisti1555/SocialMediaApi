...
namespace UnitTests.Domain.PostTests.Factories;
...
public class PostFactoryTests
{
    ...
    public void Create_Text_ValidationTest(string text, AppUser? user, bool shouldSucceed)
    {
        if (shouldSucceed)
        {
    ...
    public void Create_User_ValidationTest(string text, AppUser? user, bool shouldSucceed)
    {
        if (shouldSucceed)
        {
            var exception = Record.Exception(() =>
    ...
    [Fact]
    public void Create_BypassValidation()
    {
