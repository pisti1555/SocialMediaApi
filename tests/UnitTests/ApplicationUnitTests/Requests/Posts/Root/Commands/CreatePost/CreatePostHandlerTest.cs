...
public class CreatePostHandlerTest
{
    ...
    public CreatePostHandlerTest()
    {
        ...
        _createPostHandler = new CreatePostHandler(_postRepositoryMock.Object, _userRepositoryMock.Object, MapperHelper.GetMapper());
    ...
    public async Task Handle_ShouldSucceed()
    {
        ...
        _userRepositoryMock.Setup(x => x.GetByIdAsync(_user.Id)).ReturnsAsync(_user);
